...
export const navigationGroups: NavGroupConfig[] = [
  ...
  },
  {
    ...
    items: [
      bookingChild("all", "sidebar.bookings.all", Plane),
      bookingChild("tour", "sidebar.bookings.tour", MapPin),
      bookingChild("flight", "sidebar.bookings.flight", Ticket),
      bookingChild("hotel", "sidebar.bookings.hotel", Hotel),
      bookingChild("hajj", "sidebar.bookings.hajj", Moon),
      bookingChild("umrah", "sidebar.bookings.umrah", Moon),
      bookingChild("visa", "sidebar.bookings.visa", Stamp),
      bookingChild("student", "sidebar.bookings.student", GraduationCap),
      bookingChild("manpower", "sidebar.bookings.manpower", HardHat),
    ],
  },
  {
    id: "support",
