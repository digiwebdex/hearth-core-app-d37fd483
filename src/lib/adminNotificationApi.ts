...
const demoAdminNotifications: AdminNotification[] = [
  ...
  },
  {
    ...
    message: "Acme Travel submitted ৳1,999 payment for Professional plan via bKash (TRX-9876543).",
    read: false, link: "/admin/payments",
    createdAt: new Date(Date.now() - 1000 * 60 * 15).toISOString(),
  },
  {
    id: "an3", type: "payment_request", title: "New Payment Request",
    message: "Globe Tours submitted ৳999 payment for Starter plan via Bank Transfer (TRX-1234567).",
    read: false, link: "/admin/payments",
    createdAt: new Date(Date.now() - 1000 * 60 * 45).toISOString(),
  },
  {
    id: "an4", type: "subscription_expiring", title: "Subscription Expiring Soon",
    message: "Globe Tours Professional plan expires in 3 days. No renewal request submitted yet.",
    read: false, link: "/admin/subscriptions",
    createdAt: new Date(Date.now() - 1000 * 60 * 60 * 2).toISOString(),
  },
  {
    id: "an5", type: "new_tenant", title: "New Tenant Registered",
    message: "Sky Wings (sky@wings.com) just signed up for a Free Trial.",
    read: true, link: "/admin/tenants",
    createdAt: new Date(Date.now() - 1000 * 60 * 60 * 8).toISOString(),
  },
  {
    id: "an6", type: "subscription_expired", title: "Subscription Expired",
    message: "Star Holidays Starter plan has expired. Tenant access restricted until renewal.",
