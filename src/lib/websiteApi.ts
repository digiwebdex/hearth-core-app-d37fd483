...
export const themePresets: ThemePreset[] = [
  // ── Travel Agency (4 themes) ──
  {
    id: "skyline-blue",
    name: "Skyline Blue",
    description: "Modern corporate theme — ideal for visa, flight, and outbound agencies.",
    template: "travel-agency",
    palettePreview: ["221 83% 53%", "25 95% 53%", "210 40% 96%", "222 47% 11%"],
    colors: { primary: "221 83% 53%", secondary: "210 40% 96%", accent: "25 95% 53%", background: "0 0% 100%", text: "222 47% 11%" },
    sampleContent: { heroBadge: "Trusted Travel Partner", heroTitle: "Professional Travel Services For Every Journey", heroSubtitle: "Flight, visa, hotel, and holiday packages from one smart agency.", ctaTitle: "Need a custom itinerary?", ctaSubtitle: "Talk to our team and get a tailored travel plan fast." },
  },
  {
    id: "luxury-gold",
    name: "Luxury Gold",
    description: "Dark-navy + gold for premium, executive, and VIP travel brands.",
    template: "travel-agency",
    palettePreview: ["222 47% 11%", "38 92% 50%", "210 30% 96%", "0 0% 100%"],
    colors: { primary: "222 47% 11%", secondary: "210 30% 96%", accent: "38 92% 50%", background: "0 0% 100%", text: "222 47% 11%" },
    sampleContent: { heroBadge: "Premium Business Travel", heroTitle: "Luxury Travel Planning With VIP Attention", heroSubtitle: "From executive flights to premium tours — an elevated customer experience.", ctaTitle: "Upgrade your next trip", ctaSubtitle: "Let us design a premium package for your travelers." },
  },
  {
    id: "ocean-teal",
    name: "Ocean Teal",
    description: "Fresh teal + orange — great for cruise, sea, and international packages.",
    template: "travel-agency",
    palettePreview: ["183 74% 40%", "24 96% 55%", "183 40% 94%", "222 47% 11%"],
    colors: { primary: "183 74% 40%", secondary: "183 40% 94%", accent: "24 96% 55%", background: "0 0% 100%", text: "222 47% 11%" },
    sampleContent: { heroBadge: "Sea & International Travel", heroTitle: "Explore The World\'s Best Destinations", heroSubtitle: "Cruise packages, international tours, and sea travel — all in one agency.", ctaTitle: "Start exploring today", ctaSubtitle: "Our expert team plans every journey down to the finest detail." },
  },
  {
    id: "midnight-elite",
    name: "Midnight Elite",
    description: "Dark background + electric accent for a bold, modern brand identity.",
    template: "travel-agency",
    palettePreview: ["224 71% 4%", "199 89% 48%", "217 33% 17%", "0 0% 100%"],
    colors: { primary: "199 89% 48%", secondary: "217 33% 17%", accent: "38 92% 50%", background: "224 71% 4%", text: "210 40% 96%" },
    sampleContent: { heroBadge: "Premium Destinations", heroTitle: "Elite Travel Experiences For Discerning Explorers", heroSubtitle: "Dark, bold, and professional — designed for agencies with a modern brand.", ctaTitle: "Make your move", ctaSubtitle: "Premium travel consulting for world-class travelers." },
  },
  ...
  // ── Hajj & Umrah (4 themes) ──
  {
    id: "haramain-green",
    name: "Haramain Green",
    description: "Calm spiritual green + gold — the classic Hajj & Umrah identity.",
    template: "hajj-umrah",
    ...
    sampleContent: { heroBadge: "Trusted Hajj & Umrah Service", heroTitle: "Your Sacred Journey In Trusted Hands", heroSubtitle: "Hajj, Umrah, visa, and ziyarat — a premium pilgrimage experience.", ctaTitle: "Book your package today", ctaSubtitle: "Our team will make your sacred journey smooth and blessed." },
  },
  {
    id: "royal-maroon",
    name: "Royal Maroon",
    description: "Deep maroon + gold — refined and dignified for luxury pilgrimage services.",
    template: "hajj-umrah",
    ...
    sampleContent: { heroBadge: "Luxury Hajj & Umrah", heroTitle: "Premium Pilgrimage Packages With Full Support", heroSubtitle: "Dignified, comfortable, and spiritually enriching journeys for every pilgrim.", ctaTitle: "Plan a premium journey", ctaSubtitle: "Contact us for luxury accommodation and guided packages." },
  },
  {
    id: "desert-amber",
    name: "Desert Amber",
    description: "Warm sandy amber — earthy and authentic for Middle East travel agencies.",
    template: "hajj-umrah",
    palettePreview: ["33 95% 48%", "142 60% 40%", "34 100% 96%", "222 47% 11%"],
    colors: { primary: "33 95% 48%", secondary: "34 100% 96%", accent: "142 60% 40%", background: "0 0% 100%", text: "222 47% 11%" },
    sampleContent: { heroBadge: "Trusted Hajj Guide", heroTitle: "Your Sacred Journey In Trusted Hands", heroSubtitle: "Warm, welcoming, and complete pilgrim support from registration to return.", ctaTitle: "Book your Umrah now", ctaSubtitle: "Let our experienced guides make your journey memorable." },
  },
  {
    id: "emerald-deen",
    name: "Emerald Deen",
    description: "Deep emerald + gold — elegant, modern Islamic identity for premium agencies.",
    template: "hajj-umrah",
    palettePreview: ["160 84% 20%", "44 96% 56%", "160 30% 94%", "0 0% 100%"],
    colors: { primary: "160 84% 20%", secondary: "160 30% 94%", accent: "44 96% 56%", background: "0 0% 100%", text: "160 84% 10%" },
    sampleContent: { heroBadge: "Premium Pilgrimage Service", heroTitle: "Excellence In Every Step Of Your Holy Journey", heroSubtitle: "Trusted guides, premium hotels, and complete support for every pilgrim.", ctaTitle: "Contact us today", ctaSubtitle: "Hajj and Umrah services with care, dignity, and expertise." },
  },

  // ── Tour Packages (4 themes) ──
  {
    id: "adventure-purple",
    name: "Adventure Purple",
    description: "Energetic purple + pink — bold and visual for modern leisure brands.",
    template: "tour-packages",
    ...
    sampleContent: { heroBadge: "Adventure Awaits", heroTitle: "Weekend Tours, Holiday Packages & Group Adventures", heroSubtitle: "Turn every trip into a memorable story with visual-first package pages.", ctaTitle: "Launch your next tour", ctaSubtitle: "Promote domestic and international experiences with one click.", packagesTitle: "Featured Tours", packagesSubtitle: "Trending leisure packages with engaging cards and clear calls to action." },
  },
  {
    id: "sunset-coral",
    name: "Sunset Coral",
    description: "Warm coral + cyan — vibrant for beach, honeymoon, and resort packages.",
    template: "tour-packages",
    ...
    sampleContent: { heroBadge: "Beach & Holiday Offers", heroTitle: "Beautiful Packages For Beach, Honeymoon & Families", heroSubtitle: "Warm visuals and strong booking-focused sections for resort travel.", ctaTitle: "Promote your hot deals", ctaSubtitle: "Highlight trending packages with a vibrant layout.", packagesTitle: "Best Selling Packages", packagesSubtitle: "Push your hottest seasonal tours with strong conversion layout." },
  },
  {
    id: "tropical-cyan",
    name: "Tropical Cyan",
    description: "Bright tropical cyan + lime — for adventure, eco, and outdoor-focused agencies.",
    template: "tour-packages",
    palettePreview: ["187 96% 43%", "75 80% 46%", "187 60% 94%", "222 47% 11%"],
    colors: { primary: "187 96% 43%", secondary: "187 60% 94%", accent: "75 80% 46%", background: "0 0% 100%", text: "222 47% 11%" },
    sampleContent: { heroBadge: "Eco & Adventure Travel", heroTitle: "Discover Nature\'s Most Beautiful Destinations", heroSubtitle: "Fresh, eco-friendly tours for adventure seekers and nature lovers.", ctaTitle: "Plan your eco adventure", ctaSubtitle: "Sustainable travel packages crafted for the modern explorer.", packagesTitle: "Eco Tours & Adventures", packagesSubtitle: "Explore nature-focused packages with a tropical, fresh visual style." },
  },
  {
    id: "forest-explorer",
    name: "Forest Explorer",
    description: "Deep forest green + amber — grounded and premium for nature & trekking tours.",
    template: "tour-packages",
    palettePreview: ["145 60% 25%", "35 90% 50%", "145 30% 94%", "222 47% 11%"],
    colors: { primary: "145 60% 25%", secondary: "145 30% 94%", accent: "35 90% 50%", background: "0 0% 100%", text: "222 47% 11%" },
    sampleContent: { heroBadge: "Nature & Trekking", heroTitle: "Premium Nature Tours & Trekking Expeditions", heroSubtitle: "Earthy tones and natural identity for eco lodges, trekking, and wildlife tours.", ctaTitle: "Explore the wild", ctaSubtitle: "Guided trekking, camping, and wildlife tours for every level.", packagesTitle: "Featured Expeditions", packagesSubtitle: "Deep, grounded packages for trekkers, campers, and wildlife enthusiasts." },
  },
];
